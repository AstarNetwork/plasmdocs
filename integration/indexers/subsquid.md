...
This guide will explain how to create a Subsquid project (also known as a _"Squid"_) that indexes ERC-721 token transfers on the Astar network. As such, you'll be looking at the `Transfer` EVM event topics. This guide can be adapted for Shiden network and other type of tokens as well.
