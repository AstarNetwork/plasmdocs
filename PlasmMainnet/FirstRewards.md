...
At genesis, Plasm will use all of the rewards for `ForSecurity`. Performing dAppsStaking in the initial phase will definitely make it rough. Furthermore, countermeasures for malicious actors may not work perfectly as intended. Therefore, at genesis Plasm will adopt a simple reward algorithm.
